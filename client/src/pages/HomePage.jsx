              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
                <div className='bg-muted rounded-lg p-6 space-y-4'>
                  ...
                  <p className='text-muted-foreground'>
                    ...
                    Organize your work, set priorities, and never miss a
                    deadline.
                  </p>
                </div>
                <div className='bg-muted rounded-lg p-6 space-y-4'>
                  ...
                  <p className='text-muted-foreground'>
                    Visualize your tasks and deadlines with our powerful
                    calendar view. Easily schedule meetings, set reminders, and
              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
                ...
                <div className='bg-background rounded-lg p-6 space-y-4 shadow-md'>
                  ...
                  <p className='text-muted-foreground'>
                    ...
                    is by far the best. The calendar and project board
                    features\n have been a game-changer for my team."pps, but
                    TaskMaster is by far the best. The calendar and project
                    board features
                  </p>
                </div>
                <div className='bg-background rounded-lg p-6 space-y-4 shadow-md'>
                  ...
                  <p className='text-muted-foreground'>
                    ...
                    tasks and projects. The app is intuitive, powerful, and
